...
html {
  ...
  text-rendering: optimizeLegibility;
	...
	#Select,#Visitors,#Age,#Email,#Mobile_Number  {
...
<div class="row">
    ...
    <div class="row">
    	...
    	<div class="container-fluid" Style="margin-top: 20px;margin-left:0px;margin-right:0px;">
				...
				<tbody>
				  ...
				  <?php 
                        ...
                        if(isset($_GET['from']) && isset($_GET['to'])){
                              ...
                              $sql2="select * from apollo_upload group by clientid";
                        }
  ...
  foreach($res2 as $row){
				...
				<tr>
				    	...
				    	<th><?php $sql2 ="select * from apollo_clients where id='$row[clientid]' "; echo $easydb->fetchrow($sql2,"age"); ?></th>
				    	
				    		<th><?php  echo $easydb->fetchrow($sql,"email"); ?></th>	
				    	<th><?php echo $easydb->fetchrow($sql,"mobileno"); ?></th>
				    	
						<th style="pointer: cursor" onclick="location.href='viewPhotos.php?clientid=<?php echo $row['clientid']; ?>&&dealerid=<?php echo $row['dealerid']; ?>&&type=visitor'">View Data/Download
						</th>
   ...
   buttons: [ 'copyHtml5', 'excelHtml5', 'csvHtml5', 'pdfHtml5' ] ,
		...
		initComplete: function () {
			this.api().columns().every( function () {
				var column = this;
				var select = $('<select style="margin-left:40px;margin-right:10px" id="'+this.header().textContent.replace(" ","_") +'"><option  value="">'+this.header().textContent +'</option></select>')
					.appendTo( $("#sel") )
					.on( 'change', function () {
