...
<div class="row">
				...
				<tbody>
				  ...
				  <?php 
                        ...
                        if(isset($_GET['from']) && isset($_GET['to'])){
                              ...
                              $sql2="select * from apollo_upload";
                        }
  ...
  foreach($res2 as $row){
                      ...
                      ?>
				<tr>
                        <th style="pointer:cursor" onclick="location.href='eventDetail.php?id=<?php echo $row['eventid']; ?>'"><?php $sql ="select * from apollo_events where id='$row[eventid]' "; echo $easydb->fetchrow($sql,"eventname"); ?></th>
				    	...
				    	<th><?php $sql ="select * from apollo_dealer where id='$row[dealerid]' "; $st=$easydb->fetchrow($sql,"status"); if($st==1) echo "Active"; else echo "Suspended"; ?></th>
